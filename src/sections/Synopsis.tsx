  ...
  return (
    <section className='pt-15 pb-50' id='arasuji'>
        <div className='relative h-[284px] w-full flex items-center justify-center mb-15'>
            ...
            <img className='absolute w-[195px] h-[198px] object-cover z-5' src="/assets/planet_2.webp" alt="" />
            <img className='absolute w-[295px] h-[340px] top-0 left-1/12 block -translate-y-1/4 -translate-x-1/10' src="/assets/spy_1.webp" alt="spy 1" />
            <img className='absolute w-[150px] h-[207px] top-0 right-0 block z-10 translate-y-1/4' src="/assets/spy_2.webp" alt="spy 2" />
        </div>
