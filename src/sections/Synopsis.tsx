  ...
  return (
    <section className='pt-15 pb-50' id='arasuji'>
        <div className='relative h-[284px] w-full flex items-center justify-center mb-15'>
            ...
            <img className='absolute w-[295px] h-[340px] top-0 left-1/12 block -translate-y-1/4 -translate-x-1/10 shrink-0 object-contain' src="/assets/spy_1.webp" alt="spy 1" />
            <img className='absolute w-[150px] h-[207px] top-0 right-0 block z-10 translate-y-1/4 shrink-0 object-contain' src="/assets/spy_2.webp" alt="spy 2" />
        </div>
