  ...
  return (
    <section className='pt-15 pb-50'>
        <div className='relative h-[284px] w-full flex items-center justify-center mb-15'>
            ...
            <img className='absolute top-0 left-0 block -translate-x-1/10' src="/assets/spy_1.webp" alt="spy 1" />
            <img className='absolute top-0 right-0 block z-10 translate-y-1/4' src="/assets/spy_2.webp" alt="spy 2" />
        </div>
