...
const Synopsis: React.FC = () => {
  ...
  const spy1Y = useTransform(scrollY, [0,7000], [0,100])
  const spy2Y = useTransform(scrollY, [0, 5000], [0, -50]);
  return (
    <section className='pt-15 pb-50' id='arasuji'>
        <div className='relative h-[284px] w-full flex items-center justify-center mb-15'>
            ...
            <img className='absolute w-[195px] h-[198px] object-cover z-5 shrink-0' src="/hp/assets/planet_2.webp" alt="" />
            <motion.img 
            className='absolute w-[295px] h-[340px] top-0 left-1/12 block -translate-y-1/4 -translate-x-1/10 shrink-0 object-contain' 
            src="/hp/assets/spy_1.webp" 
            alt="spy 1" 
            style={{ y:spy1Y }}
            />
            <motion.img 
            className='absolute w-[150px] h-[207px] top-0 right-0 block z-10 translate-y-1/4 shrink-0 object-contain' 
            src="/hp/assets/spy_2.webp" 
            alt="spy 2" 
            style={{ y:spy2Y }}
            />
        </div>
